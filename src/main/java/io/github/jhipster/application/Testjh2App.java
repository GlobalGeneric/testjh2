...
public class Testjh2App {

    private static final Logger log = LoggerFactory.getLogger(Testjh2App.class);

    private final Environment env;

    public Testjh2App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Testjh2App.class);
